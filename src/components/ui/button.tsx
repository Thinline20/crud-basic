  ...
  "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    ...
    variants: {
      ...
      variant: {
        ...
        muted: "bg-muted-foreground text-muted hover:bg-muted-foreground/90",
        outline:
...
<div class="relative after:absolute after:bottom-2 after:h-[1px] after:w-2/3 after:origin-bottom-right after:scale-x-0 after:bg-primary after:transition-transform after:duration-300 after:ease-in-out hover:after:origin-bottom-left hover:after:scale-x-100" />;
  ...
  return (
    ...
    >
      <Show when={props.Icon && props.iconPosition === "left"}>
        <span class="group-hover:translate-x-100 w-0 translate-x-[0%] pr-0 opacity-0 transition-all duration-200 group-hover:w-5 group-hover:pr-2 group-hover:opacity-100">
          {props.Icon}
        </span>
      </Show>
      {props.children}
      <Show when={props.Icon && props.iconPosition === "right"}>
        <span class="w-0 translate-x-[100%] pl-0 opacity-0 transition-all duration-200 group-hover:w-5 group-hover:translate-x-0 group-hover:pl-2 group-hover:opacity-100">
          {props.Icon}
        </span>
      </Show>
    </button>
